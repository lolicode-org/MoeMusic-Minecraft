...
object ClientPlaybackHandler {
    ...
    fun sendHandshake(locale: String, modVersion: String, protocolVersion: Int, initialState: ClientStateProto) {
        ...
        val id = ResourceLocation.fromNamespaceAndPath(PacketIds.CLIENT_HANDSHAKE.namespace, PacketIds.CLIENT_HANDSHAKE.path)
    ...
    private fun send(packetId: PacketId, payload: ByteArray) {
        val id = ResourceLocation.fromNamespaceAndPath(packetId.namespace, packetId.path)
