...
internal class ConfigScreenSubtitleWidget(
    ...
    companion object {
        ...
        private fun attachRenderable(screen: Screen, renderable: Widget) {
            try {
                val method = Screen::class.java.declaredMethods.firstOrNull {
                    it.parameterCount == 1 &&
                        it.parameterTypes[0].isAssignableFrom(renderable::class.java) &&
            ...
            try {
                ...
                if (field != null) {
                    ...
                    (field.get(screen) as? MutableList<Widget>)?.add(renderable)
                }
            } catch (_: Throwable) {}
        }
    }
    ...
    override fun render(poseStack: PoseStack, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        val context = GuiGraphics(poseStack, screenWidth, screen.height)
