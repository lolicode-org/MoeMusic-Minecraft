...
object ClientNetworkSetup {
    ...
    fun register() {
        ...
        ).forEach { PlayPackets.registerClientChannel(ResourceLocation.fromNamespaceAndPath(it.namespace, it.path)) }
    ...
    fun advertiseClientChannels() {
        val channels = listOf(
            ...
            PacketIds.PLAYBACK_CONTROL_RESPONSE,
            PacketIds.CONTENT_FILTER_ACTION_RESPONSE,
        ).map { ResourceLocation.fromNamespaceAndPath(it.namespace, it.path) }.toSet()
